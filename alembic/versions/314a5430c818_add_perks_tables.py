...
def upgrade():
    ...
    orm = create_session()
    driver_standard = PerksRepository.add(name='driver_standard',
                                          duration=365,
                                          fixed_rate=0.0,
                                          multiplier=0.0,
                                          per_seat_cost=0.0,
    ...
    passenger_standard = PerksRepository.add(name='passenger_standard',
                                             duration=365,
                                             fixed_rate=0.0,
                                             multiplier=0.0,
                                             per_seat_cost=0.0,
    ...
    for u in User.query:
        ...
        orm.add(PerksRepository.add_driver_perk(u, driver_standard))
        orm.add(PerksRepository.add_passenger_perk(u, passenger_standard))
        orm.add(u)
    orm.commit()
