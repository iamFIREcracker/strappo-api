...
class DriverCreator(Publisher):
    def perform(self, repository, user_id, car_type, license_plate, telephone):
        ...
        """
        driver = repository.add(user_id, car_type, license_plate, telephone)
...
def serialize(driver):
    if driver is None:
        return None
    return dict(id=driver.id, car_type=driver.car_type,
