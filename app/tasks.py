...
from app.weblib.logger import create_logger
...
@celery.task
class NotifyDriversTask(object):
    def __call__(self, passenger_id):
        ...
        notify_drivers.perform(logger, DriversRepository, passenger_id,
                               push_adapter)
        return ret.get()
